...
let currentIndex=0;
  ...
  function renderPosts() {
    ...
    postsContainer.innerHTML = '';
      ...
      authorElement.textContent = postsData[currentIndex].author;
    
      const contentElement = document.createElement('p');
      contentElement.textContent = postsData[currentIndex].content;
    
      const imageElement = document.createElement('img');
      imageElement.src = postsData[currentIndex].image;
      ...
      postFooter.textContent = `Likes: ${post1.likes}   Comments:   ${postsData[currentIndex].comments.length}`;
    
      const commentsContainer = document.createElement('div');
      commentsContainer.classList.add('comments-container');
      commentsContainer.style.display = 'none';
    
      postsData[currentIndex].comments.forEach((comment) => {
    ...
    function addComment(comment) {
      postsData[currentIndex].comments.push(comment);
      renderPosts();
    }
    renderPosts();    